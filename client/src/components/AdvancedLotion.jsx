        ...
        <>
            ...
            ">
                ...
                ">
                    ...
                    {/* Floating Image */}
                    <div className="
                        w-[200px] sm:w-[200px] lg:w-[210px] xl:w-[230px] 2xl:w-[250px]
                        absolute bg-[#dfdace]
                        bottom-[-6rem] sm:bottom-[-5rem] lg:bottom-[-4.5rem] xl:bottom-[-5.5rem] 2xl:bottom-[-6rem]
                        right-[-4rem] sm:right-[-4rem] lg:right-[-3rem] xl:right-[-3.5rem] 2xl:right-[-4rem]
