    ...
    return (
        <>
            <section className="
                ...
                py-[1rem] sm:py-[2rem] lg:py-[0.8rem] xl:py-[0.9rem] 2xl:py-[1rem]
            ...
            ">
                ...
                <div className="
                    w-[80%] sm:w-[36%]
                    bg-[#e5e0d5] relative
                    rounded-[45px] sm:rounded-[47px] lg:rounded-[65px] xl:rounded-[75px] 2xl:rounded-[80px]
                    pt-[0] sm:pt-[0.5rem] lg:pt-[0.6rem] xl:pt-[0.8rem] 2xl:pt-[1rem]
                    pb-[2rem] sm:pb-[2.2rem] lg:pb-[3.6rem] xl:pb-[3.8rem] 2xl:pb-[4rem]
                ">
                    <img
                    ...
                    {/* Floating Image */}
                    <div className="
                        w-[60%] sm:w-[170px] lg:w-[210px] xl:w-[230px] 2xl:w-[250px]
                        absolute bg-[#e5e0d5] shadow-md
                        bottom-[-4.5rem] sm:bottom-[-4rem] lg:bottom-[-4.5rem] xl:bottom-[-5.5rem] 2xl:bottom-[-6rem]
                        right-[-24%] sm:right-[-3rem] lg:right-[-3rem] xl:right-[-3.5rem] 2xl:right-[-4rem]
                        rounded-[35px] sm:rounded-[30px] lg:rounded-[40px] xl:rounded-[45px] 2xl:rounded-[50px]
                        p-[0.8rem] sm:p-0
                ...
                ">
                    ...
                    <Link to="/products" className="
                        ...
                        rounded-[30px]
                        text-[0.9rem] sm:text-[1rem] lg:text-[0.8rem] xl:text-[0.88rem] 2xl:text-[0.95rem]
