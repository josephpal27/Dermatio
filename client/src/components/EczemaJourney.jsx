...
const EczemaJourney = () => {
    return (
        <>
            <section className="
                px-[7%]
                py-[4.5rem] sm:py-[4rem] lg:py-[3.5rem] xl:py-[4rem] 2xl:py-[4.5rem]
            ">
                <h4 className="
                ...
                <div className="
                    ...
                    rounded-[70px] sm:rounded-[70px] lg:rounded-[55px] xl:rounded-[65px] 2xl:rounded-[70px]
                ">
                    {/* Image */}
                    <div className="
                        w-[40%]
                    ...
                    ">
                        <p className="
                            text-[#363636]
                            text-[1.4rem] sm:text-[1.4rem] lg:text-[1.15rem] xl:text-[1.3rem] 2xl:text-[1.4rem]
                            w-[80%]
                        ">
