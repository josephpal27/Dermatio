...
const CartSummary = () => {
    ...
    return (
        <>
            <div className="
                bg-[#eee7dd]
                rounded-[15px] sm:rounded-[14px] lg:rounded-[11px] xl:rounded-[13px] 2xl:rounded-[15px]
                p-[1.2rem] sm:p-[1.5rem] lg:p-[1.2rem] xl:p-[1.35rem] 2xl:p-[1.5rem]
            ">
                <span className="
                    text-[1.2rem] sm:text-[1.5rem] lg:text-[1.1rem] xl:text-[1.2rem] 2xl:text-[1.3rem]
                    font-[600]
                ...
                <div className="
                    ...
                    text-[1.1rem] sm:text-[1.4rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]
                ">
                    <span>
                ...
                <div className="
                    ...
                    text-[1.3rem] sm:text-[1.6rem] lg:text-[1.3rem] xl:text-[1.4rem] 2xl:text-[1.5rem]
                ">
                    <span>
                        Total
                    </span>
                ...
                <Link 
                    ...
                    className="
                        ...
                        text-[1.2rem] sm:text-[1.3rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]
