        ...
        <>
            ...
            ">
                ...
                <div className="
                    ...
                    py-[1.5rem] sm:py-[1.2rem] lg:py-[1.15rem] xl:py-[1.35rem] 2xl:py-[1.5rem]
                ...
                ">
                    ...
                    <span className="
                        text-[1.2rem] sm:text-[1rem] lg:text-[0.95rem] xl:text-[1.1rem] 2xl:text-[1.2rem]
                        text-[#565656]
                    ">
                        {item.type} - {item.size}
                    </span>
                    ...
                    <div className="
                        ...
                        flex items-center
                        gap-[1.3rem] sm:gap-[1.1rem] lg:gap-[1.1rem] xl:gap-[1.2rem] 2xl:gap-[1.3rem]
                        px-[1rem] sm:px-[1rem] lg:px-[0.8rem] xl:px-[0.9rem] 2xl:px-[1rem]
                        py-[0.3rem] sm:py-[0.3rem] lg:py-[0.23rem] xl:py-[0.28rem] 2xl:py-[0.3rem]
                        rounded-full
                    ">
                    ...
                    {/* Buy Now & Remove Btn */}
                    <div className="
                        mt-[1.1rem] sm:mt-[1rem] lg:mt-[0.9rem] xl:mt-[1rem] 2xl:mt-[1.1rem]
                    ...
                    ">
                        ...
                        <Link 
                            ...
                            className="
                                ...
                                px-[1.1rem] sm:px-[1.1rem] lg:px-[0.9rem] xl:px-[1rem] 2xl:px-[1.1rem]
                                py-[0.3rem] sm:py-[0.3rem] lg:py-[0.23rem] xl:py-[0.28rem] 2xl:py-[0.3rem]
