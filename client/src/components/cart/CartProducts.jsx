...
const CartProducts = () => {
    ...
    return (    
        <>
            <section className="
                px-[7%]
                pt-[2rem] sm:pt-[1.5rem] lg:pt-[1.4rem] xl:pt-[1.7rem] 2xl:pt-[2rem]
                pb-[5rem] sm:pb-[4rem] lg:pb-[4rem] xl:pb-[4.5rem] 2xl:pb-[5rem]
            ">
                <div className="
                        ...
                        {cart.length === 0 ? (
                            ...
                            ">
                                ...
                                <p className="
                                    ...
                                    mt-[0.5rem] sm:mt-[0.5rem] lg:mt-[0.4rem] xl:mt-[0.45rem] 2xl:mt-[0.5rem]
                                ">
                                ...
                                <Link
                                    ...
                                    className="
                                        ...
                                        px-[1.5rem] sm:px-[1.2rem] lg:px-[1.3rem] xl:px-[1.4rem] 2xl:px-[1.5rem]
                                        py-[0.6rem] sm:py-[0.5rem] lg:py-[0.5rem] xl:py-[0.55rem] 2xl:py-[0.6rem]
