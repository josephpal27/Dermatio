    ...
    return (    
        <>
            <section className="
                ...
                pb-[2rem] sm:pb-[2.5rem] lg:pb-[4rem] xl:pb-[4.5rem] 2xl:pb-[5rem]
            ">
                <div className="
                ...
                ">
                    {/* Cart Products List */}
                    <div className={`
                        ${cart.length === 0 ? "w-full" : "w-[100%] lg:w-[67%]"}
                    `}>
                        {cart.length === 0 ? (
                            <div className="
                            ...
                            ">
                                <span className="
                                    text-[1.75rem] sm:text-[1.8rem] lg:text-[1.45rem] xl:text-[1.65rem] 2xl:text-[1.8rem]
                                ...
                                <p className="
                                    text-[#565656] 
                                    text-[0.95rem] sm:text-[1.3rem] lg:text-[1rem] xl:text-[1.1rem] 2xl:text-[1.2rem]
                                ...
                                <Link
                                    ...
                                    className="
                                        ...
                                        text-[1.1rem] sm:text-[1.3rem] lg:text-[0.85rem] xl:text-[1rem] 2xl:text-[1.1rem]
                                    "
                                >
                                    Continue Shopping
                                </Link>
