...
const CheckoutSummary = ({ products, quantities, handleCheckout }) => {
    ...
    return (
        <>
            ...
            ">
                <span className="
                    text-[1.1rem] sm:text-[1.5rem] lg:text-[1.1rem] xl:text-[1.2rem] 2xl:text-[1.3rem]
                    font-[600]
                ...
                <div className="
                    ...
                    text-[1rem] sm:text-[1.3rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]
                ">
                    <span>
                ...
                <div className="
                    ...
                    text-[0.9rem] sm:text-[1.1rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]
                ">
                    <span>
                        CGST
                    </span>
                ...
                <button
                    ...
                    className="
                        mt-[1.3rem] sm:mt-[1.2rem] lg:mt-[1.3rem] xl:mt-[1.4rem] 2xl:mt-[1.5rem]
                        ...
                        text-[1.1rem] sm:text-[1.2rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]
