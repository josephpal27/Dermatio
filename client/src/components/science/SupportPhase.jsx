    ...
    return (
        <>
            <section className="
                ...
                py-[0] sm:py-[2rem] lg:py-[2.3rem] xl:py-[2.7rem] 2xl:py-[3rem]
                flex justify-between items-center flex-wrap
            ">
                <div className="w-full sm:w-[23%]">
                    <img src="/images/science/support-phase-1.avif" alt="Support Phase 1" loading="lazy" className="
                        w-full rounded-3xl
                    " />
                </div>
                <div className="w-full sm:w-[45%] my-[1.7rem] sm:my-0">
                    <h4 className="
                    ...
                    <p className="
                        text-[1.06rem] sm:text-[1.2rem] lg:text-[0.95rem] xl:text-[1.1rem] 2xl:text-[1.2rem]
                        mt-[1.3rem] sm:mt-[1rem] lg:mt-1.8rem] xl:mt-[1.9rem] 2xl:mt-[2rem]
                        text-[#363636] text-left sm:text-center
                ...
                <div className="w-full sm:w-[23%]">
                    <img src="/images/science/support-phase-2.avif" alt="Support Phase 2" loading="lazy" className="
                        w-full rounded-3xl
                    " />
                </div>
            </section>
